...
drawCredits()
{
	...
	writeCString(gfx, screen, 20, 70, "this is dd2 version xxx", 0);
	writeCString(gfx, screen, 20, 100, "main author", 1);
	writeCString(gfx, screen, 40, 125, "juan j. martinez", 0);
	writeCString(gfx, screen, 40, 160, "thanks you for playing...", 0);
